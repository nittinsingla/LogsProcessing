package com.amazon.logsprocssing.app;

import java.io.BufferedReader;
import java.io.FileReader;
import java.io.IOException;

import com.amazon.logsprocssing.bo.LogLine;
import com.amazon.logsprocssing.ip.strategy.IPStrategy;
import com.amazon.logsprocssing.ip.strategy.impl.IPV4StrategyImpl;
import com.amazon.logsprocssing.parsedate.strategy.ParseDateStratgy;
import com.amazon.logsprocssing.parsedate.strategy.impl.ParseTimeStrategyImpl;
import com.amazon.logsprocssing.template.impl.ParseLogLineImpl;
import com.amazon.logsprocssing.username.strategy.UserIdStrategy;
import com.amazon.logsprocssing.username.strategy.impl.AlphaNumericUserIdStrategy;
...
public class LogProcessingMainApp {
	...
	private static ParseLogLineImpl getParseLogLine() {
		...
		ParseDateStratgy parseDateStratgy = new ParseTimeStrategyImpl();
