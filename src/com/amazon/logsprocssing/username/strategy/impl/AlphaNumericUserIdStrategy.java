package com.amazon.logsprocssing.username.strategy.impl;
...
public class AlphaNumericUserIdStrategy implements UserIdStrategy {
	...
	public static void main(String[] args) {
		AlphaNumericUserIdStrategy alphaNumericUserNameStrategy = new AlphaNumericUserIdStrategy();
		System.out.println(alphaNumericUserNameStrategy
				.isValidUserId("USER"));
