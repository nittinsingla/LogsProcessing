package com.amazon.logsprocssing.template.impl;
...
import com.amazon.logsprocssing.template.ParseLogLineTemplate;
import com.amazon.logsprocssing.user.actions.UserAction;
...
public class ParseLogLineImpl extends ParseLogLineTemplate {
	...
	private ParseDateStratgy parseDateStratgy;

	private IPStrategy ipStrategy;

	private UserIdStrategy userIdStrategy;

	public ParseDateStratgy getParseDateStratgy() {
		return parseDateStratgy;
	}

	public void setParseDateStratgy(ParseDateStratgy parseDateStratgy) {
